...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParam messageParam)
        {
            ...
            var messageFromRepo = await _repo.GetMessagesForUser(messageParam);
        ...
        public async Task<IActionResult> DeleteMessage(int id, int userId)
        {
            ...
            {
                messageFromRepo.RecipientDeleteed = true;
            }

            if (messageFromRepo.SenderDeleted && messageFromRepo.RecipientDeleteed)
            {
